...
source "amazon-ebs" "XL" {
  ami_name                    = "Sourcegraph-XL (v${var.instance_version}) m6a.24xlarge"
  ami_description             = "Sourcegraph-XL (v${var.instance_version}) m6a.24xlarge"
