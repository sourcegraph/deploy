...
source "amazon-ebs" "L" {
  ...
  ami_name                     = "Sourcegraph-L (v${var.instance_version}) m6a.12xlarge"
  ami_description              = "Sourcegraph-L (v${var.instance_version}) m6a.12xlarge"
