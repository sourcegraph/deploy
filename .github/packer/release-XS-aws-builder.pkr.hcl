...
source "amazon-ebs" "XS" {
  ...
  ami_name                    = "Sourcegraph-XS (v${var.instance_version}) m6a.2xlarge"
  ami_description             = "Sourcegraph-XS (v${var.instance_version}) m6a.2xlarge"
